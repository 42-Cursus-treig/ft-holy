...
export const projectDefinitions = {
    ...
    "piscine-django": {
        ...
        modules: [
            ...
            { id: "django-1", label: "Starting", parents: ["django-0"] },
    ...
    "piscine-ror": {
        ...
        modules: [
            ...
            { id: "ruby-2", label: "Oob", parents: ["ruby-1"] },
            { id: "ruby-3", label: "Gems", parents: ["ruby-2"] },
            { id: "ruby-4", label: "Base Rails", parents: ["ruby-3"] },
            { id: "ruby-5", label: "SQL", parents: ["ruby-4"] },
            { id: "ruby-6", label: "Sessions", parents: ["ruby-5"] },
            { id: "ruby-7", label: "Advanced", parents: ["ruby-6"] },
            { id: "ruby-8", label: "Final", parents: ["ruby-7"] },
        ],
    },
    "piscine-symfony": {
        lang: "php",
        ...
        modules: [
            ...
            { id: "symfony-3", label: "Composer", parents: ["symfony-2"] },
            { id: "symfony-4", label: "Base Symfony", parents: ["symfony-3"] },
            { id: "symfony-5", label: "SQL", parents: ["symfony-4"] },
            { id: "symfony-6", label: "Sessions", parents: ["symfony-5"] },
            { id: "symfony-7", label: "Advanced", parents: ["symfony-6"] },
            { id: "symfony-8", label: "Final", parents: ["symfony-7"] },
        ],
    },
    "piscine-mobile": {
        parents: ["tronc-commun"],
